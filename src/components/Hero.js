      ...
      <div className='container mx-auto h-full'>
        <div className='flex items-center h-full pt-8'>
          <div className='flex-1 flex flex-col items-center lg:items-start mt-32'>
           ...
           <a href="https://www.linkedin.com/in/elaheerazob/" target="_blank"> <button className='btn btn-md bg-accent hover:bg-secondary-hover md:btn-lg transition-all mt-10'>
              Hire Me
            </button></a>
          </div>
